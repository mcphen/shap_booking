...
<div class="layout-top-spacing profile-page">
    <div class="statbox widget box box-shadow">
        <div class="widget-header">
            ...
            <form class="" action="{{dashboard_url('update-profile-partner')}}" enctype="multipart/form-data" method="POST" autocomplete="off">
                @csrf
                        ...
                        <div class="form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div id="phone-field" class="field-wrapper input">
                                            <label for="phone">{{__('Piece d\'identite')}}</label>
                                            <input class="form-control" type="file" name="piece_identite" id="piece_identite" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div id="phone-field" class="field-wrapper input">
                                            <label for="phone">{{__('justificatif')}}</label>
