...
class Hotel extends Model
{
    ...
    public function setFillable()
    {
        $fields = Eventy::filter('gmz_hotel_fillable', [
            'post_title', 'post_slug', 'post_content', 'post_description', 'location_lat', 'location_lng',
            'location_address', 'location_zoom', 'thumbnail_id', 'gallery', 'base_price',
            'extra_services', 'hotel_star', 'hotel_logo', 'video', 'policy',
            'checkin_time', 'checkout_time', 'min_day_booking', 'min_day_stay',
            'nearby_common', 'nearby_education', 'nearby_health', 'nearby_top_attractions',
