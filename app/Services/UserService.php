...
class UserService extends AbstractService
{
    ...
    public function partnerRegister(Request $request)
    {
        ...
        $filenamePiece="";
        $pathPieceIdentite="";
        $filenameJustificatif="";
        $pathJustificatif="";
        if($request->hasFile('piece_identite')){
            $piece_identite = $request->file('piece_identite');
            // generate a new filename. getClientOriginalExtension() for the file extension
            $filenamePiece = $piece_identite->getClientOriginalName().'-' . time() . '.' . $piece_identite->getClientOriginalExtension();
            // save to storage/app/photos as the new $filename
            $pathPieceIdentite = $piece_identite->storeAs('public/partner', $filenamePiece);
        }
        if($request->hasFile('justificatif')){
            $justificatif = $request->file('justificatif');
            // generate a new filename. getClientOriginalExtension() for the file extension
            $filenameJustificatif = $justificatif->getClientOriginalName().'-' . time() . '.' . $justificatif->getClientOriginalExtension();
            // save to storage/app/photos as the new $filename
            $pathJustificatif = $justificatif->storeAs('public/partner', $filenameJustificatif);
        }
    ...
    public function updateProfile(Request $request)
    {
        ...
        $data = apply_filter('gmz_user_insert_data', [
            ...
            'piece_identite' => $filenamePiece,
            'piece_identite_path'=>$pathPieceIdentite,
            'justificatif' => $filenameJustificatif,
            'justificatif_path' => $pathJustificatif,
            'phone' => $request->post('phone', ''),
